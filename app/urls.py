...
from app.views import (IndexView, APIView,DashboardView,ObservationView,ObservationRecordView ,CourseView,UserView, AboutView, PricingView, PricingPlanView, ContactView)
